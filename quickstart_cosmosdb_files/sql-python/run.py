...
HOST = config_example.settings['host']
MASTER_KEY = config_example.settings['master_key']
DATABASE_ID = config_example.settings['database_id']
CONTAINER_ID = config_example.settings['container_id']
